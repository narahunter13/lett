<div class="container mx-auto">
    <div class="w-64">
        <div class="relative">
            <input type="text" readonly x-model="datepickerValue" @click="showDatepicker = !showDatepicker" @keydown.escape="showDatepicker = false" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40" placeholder="Select date">
            ...
            <div class="bg-white mt-12 rounded-lg shadow p-4 z-50 absolute top-0 left-0" style="width: 22rem" x-show.transition="showDatepicker" @click.away="showDatepicker = false">
